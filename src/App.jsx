...
const linkCards = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path
          fill="#1DB954"
          d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2Zm4.36 14.45a.77.77 0 0 1-1.06.24 8.58 8.58 0 0 0-6.95-.92.77.77 0 1 1-.43-1.48 10.13 10.13 0 0 1 8.2 1.09.77.77 0 0 1 .24 1.07Zm1.08-2.4a.95.95 0 0 1-1.31.31 10.56 10.56 0 0 0-8.49-1.08.95.95 0 1 1-.53-1.82 12.44 12.44 0 0 1 10.03 1.28.95.95 0 0 1 .3 1.31Zm.1-2.5A12.61 12.61 0 0 0 7.29 10.3a1.13 1.13 0 1 1-.63-2.18 14.87 14.87 0 0 1 11.99 1.53 1.13 1.13 0 1 1-1.11 1.9Z"
        />
      </svg>
    ),
  },
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <circle cx="4.8" cy="12" r="3.2" fill="#FF8000" />
        <circle cx="12" cy="12" r="3.2" fill="#00E054" />
        <circle cx="19.2" cy="12" r="3.2" fill="#40BCF4" />
      </svg>
    ),
  },
];
